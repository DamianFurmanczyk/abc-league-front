...
StripeCard.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: StripeCard, selectors: [["stripe-card"]], inputs: { token: "token", options: "options" }, outputs: { tokenChange: "tokenChange", cardMounted: "cardMounted" }, exportAs: ["StripeCard"], features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 1, vars: 1, consts: [[4, "ngIf"], [2, "color", "red"]], template: function StripeCard_Template(rf, ctx) { if (rf & 1) {
